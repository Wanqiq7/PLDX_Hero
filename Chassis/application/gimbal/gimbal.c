              ...
              .angle_PID =
                  {
                      ...
                      .IntegralLimit = 800,  // 旧代码I限幅±19999，按比例折算约800
                .DeadBand = 0.05,
                      .MaxOut = 800,  // 提高输出限幅，确保能克服静摩擦
                  },
              .speed_PID =
                  {
                      .Kp = 62.5f,    // 参考旧代码世界角补偿Kp=21，放大约2.4倍适配GM6020
                ...
                .IntegralLimit = 3000,  // 旧代码I限幅±9999，按比例折算约3000
              ...
              .angle_PID =
                  {
                      ...
                      .Improve =
                          PID_DerivativeFilter | PID_Derivative_On_Measurement | PID_Integral_Limit | PID_Trapezoid_Intergral,
                .IntegralLimit = 500,
                      .DeadBand = 0.1,
                      .MaxOut = 800, // 降低输出限制
                  },
