...
void BMI088_ProcessAccelData(void)
{
	...
	BMI088_Accel[0]=BMI088_RawAccelData[0]*0.0008974358974f*1.00386322f;
	BMI088_Accel[1]=BMI088_RawAccelData[1]*0.0008974358974f*1.00386322f;
	BMI088_Accel[2]=BMI088_RawAccelData[2]*0.0008974358974f*1.00386322f;
...
void BMI088_ProcessGyroData(void)
{
	...
	BMI088_Gyro[0]=BMI088_RawGyroData[0]*0.00106526443603169529841533860381f+0.000373020244f;
	BMI088_Gyro[1]=BMI088_RawGyroData[1]*0.00106526443603169529841533860381f-0.00386923435f;
	BMI088_Gyro[2]=BMI088_RawGyroData[2]*0.00106526443603169529841533860381f-0.00204937928f;
