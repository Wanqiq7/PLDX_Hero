...
void INS_Task(void)
{
    ...
    if ((count % 1) == 0)
    {
        INS.Accel[X] = BMI088_Accel[X];
        INS.Accel[Y] = BMI088_Accel[Y];
        INS.Accel[Z] = BMI088_Accel[Z];
        INS.Gyro[X] = BMI088_Gyro[X];
        INS.Gyro[Y] = BMI088_Gyro[Y];
        INS.Gyro[Z] = BMI088_Gyro[Z];
