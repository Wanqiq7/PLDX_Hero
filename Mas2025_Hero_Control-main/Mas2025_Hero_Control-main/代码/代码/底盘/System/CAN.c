...
uint32_t CAN_CAN1IDList[10][2]={{CAN_M3508,M3508_1},{CAN_M3508,M3508_2},{CAN_M3508,M3508_3},{CAN_M3508,M3508_4},{CAN_GM6020,GM6020_1},{CAN_GM6020,GM6020_2},{CAN_GM6020,GM6020_3},{CAN_GM6020,GM6020_4},0};//CAN1总线上设备ID列表
#ifdef Ultra_CAP
	uint32_t CAN_CAN2IDList[10][2]={{CAN_GM6020,GM6020_1},{CAN_Ultra_CAP,Ultra_CAP_Slave},{CAN_RoboMasterC,CToC_SlaveID1},{CAN_RoboMasterC,CToC_SlaveID2},{CAN_RoboMasterC,CToC_SlaveID4},0};//CAN2总线上设备ID列表
	uint8_t CAN_CAN1DeviceNumber=8;//CAN1总线上设备数量
	uint8_t CAN_CAN2DeviceNumber=5;//CAN2总线上设备数量
	uint8_t CAN_DeviceNumber=13;//CAN总线上设备数量
#else
	uint32_t CAN_CAN2IDList[10][2]={{CAN_GM6020,GM6020_1},{CAN_RoboMasterC,CToC_SlaveID1},{CAN_RoboMasterC,CToC_SlaveID2},{CAN_RoboMasterC,CToC_SlaveID4},0};//CAN2总线上设备ID列表
	uint8_t CAN_CAN1DeviceNumber=8;//CAN1总线上设备数量
	uint8_t CAN_CAN2DeviceNumber=4;//CAN2总线上设备数量
	uint8_t CAN_DeviceNumber=12;//CAN总线上设备数量
#endif
...
void CAN1_RX0_IRQHandler(void)
{
	if(CAN_GetITStatus(CAN1,CAN_IT_FMP0)==SET)//查询接收中断标志位
	{
		...
		else if(CAN_CAN1IDList[CAN_IDSelect][0]==CAN_GM6020)GM6020_CAN1DataProcess(ID,Data);//处理GM6020的数据
		else if(CAN_CAN1IDList[CAN_IDSelect][0]==CAN_DM_G6220)DM_G6220_DataProcess(ID,Data);
...
float PM_Voltage,PM_Current,PM_Power;
...
void CAN2_RX1_IRQHandler(void)
{
	if(CAN_GetITStatus(CAN2,CAN_IT_FMP1)==SET)//查询接收中断标志位
	{
		...
		else if(CAN_CAN2IDList[CAN_IDSelect-CAN_CAN1DeviceNumber][0]==CAN_DM_G6220)DM_G6220_DataProcess(ID,Data);
		else if(CAN_CAN2IDList[CAN_IDSelect-CAN_CAN1DeviceNumber][0]==CAN_Ultra_CAP)Ultra_CAP_DataProcess(Data);
