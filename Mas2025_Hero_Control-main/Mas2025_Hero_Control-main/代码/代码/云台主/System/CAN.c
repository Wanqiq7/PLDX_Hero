...
uint8_t CAN_CAN1DeviceNumber=1;//CAN1总线上设备数量
uint8_t CAN_CAN2DeviceNumber=2;//CAN2总线上设备数量
uint8_t CAN_DeviceNumber=3;//CAN总线上设备数量
uint32_t CAN_CAN1IDList[10][2]={{CAN_DM_J4310,DM_J4310_2+DM_J4310_IDReceiveOffset},0};//CAN1总线上设备ID列表
