...
void Keyboard_DataProcess(uint8_t *Data)
{
	...
	Remote_RxData.Remote_KeyLast_R=Remote_RxData.Remote_Key_R;
	Remote_RxData.Remote_KeyLast_F=Remote_RxData.Remote_Key_F;
	Remote_RxData.Remote_KeyLast_C=Remote_RxData.Remote_Key_C;
	...
	if(Remote_RxData.Remote_KeyLast_R==0 && Remote_RxData.Remote_Key_R==1)Remote_RxData.Remote_KeyPush_R=!Remote_RxData.Remote_KeyPush_R;
	if(Remote_RxData.Remote_KeyLast_F==0 && Remote_RxData.Remote_Key_F==1)Remote_RxData.Remote_KeyPush_F=!Remote_RxData.Remote_KeyPush_F;
	if(Remote_RxData.Remote_KeyLast_C==0 && Remote_RxData.Remote_Key_C==1)Remote_RxData.Remote_KeyPush_C=!Remote_RxData.Remote_KeyPush_C;
