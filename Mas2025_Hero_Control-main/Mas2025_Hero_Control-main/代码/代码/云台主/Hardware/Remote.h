...
typedef struct
{
	...
	uint8_t Remote_Key_R;//键盘W键,按下为1,未按下为0
	uint8_t Remote_Key_F;//键盘S键,按下为1,未按下为0
	uint8_t Remote_Key_G;//键盘A键,按下为1,未按下为0
	uint8_t Remote_Key_Z;//键盘D键,按下为1,未按下为0
	uint8_t Remote_Key_X;//键盘Q键,按下为1,未按下为0
	uint8_t Remote_Key_C;//键盘E键,按下为1,未按下为0
	uint8_t Remote_Key_V;//键盘E键,按下为1,未按下为0
	uint8_t Remote_Key_B;//键盘E键,按下为1,未按下为0
	...
	uint8_t Remote_KeyLast_R;//上一次键盘E键
	uint8_t Remote_KeyLast_F;//上一次键盘E键
	uint8_t Remote_KeyLast_C;//上一次键盘E键
	...
	uint8_t Remote_KeyPush_R;//按下键盘E键,按下时0,1切换
	uint8_t Remote_KeyPush_F;//按下键盘E键,按下时0,1切换
	uint8_t Remote_KeyPush_C;//按下键盘E键,按下时0,1切换
