...
#define DM_J4310_VMAX		10.0f
#define DM_J4310_TMAX		28.0f
...
{
	uint8_t Data[8];
	if(tau>DM_J4310_TMAX)tau=DM_J4310_TMAX;
	if(tau<-DM_J4310_TMAX)tau=-DM_J4310_TMAX;
...
void DM_J4310_DataProcess(DM_J4310_ID ID,uint8_t *Data)
{
	...
	NowAngle=uint_to_float(Position,-DM_J4310_PMAX,DM_J4310_PMAX,16);//本次机械角度原始数据
