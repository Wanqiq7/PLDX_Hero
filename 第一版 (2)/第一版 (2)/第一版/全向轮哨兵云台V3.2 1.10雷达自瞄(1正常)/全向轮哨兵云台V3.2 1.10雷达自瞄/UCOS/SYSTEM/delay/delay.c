...
void delay_init(u8 SYSCLK)
{
	...
	reload*=1000000/delay_ostickspersec;	//根据delay_ostickspersec设定溢出时间      （1/200秒*1000000微秒）1s条200次，1次跳5ms
											//reload为24位寄存器,最大值:16777216,在72M下,约合1.86s左右	
	fac_ms=1000/delay_ostickspersec;		//代表OS可以延时的最少单位	   
	SysTick->CTRL|=SysTick_CTRL_TICKINT_Msk;//开启SYSTICK中断		(CTRL控制及状态寄存器)
